...
const Jumbotron = () => {
    return (
        <div className="mb-4 rounded-3 mx-5 mt-4" style={{ backgroundColor: '#FFC0CB' }}>
            <div className="container-fluid py-5 text-start">
                ...
                <button className="btn btn-primary btn-lg" style={{ backgroundColor: 'rgb(217 76 135 / 77%)', border: 'none' }}>
                    Call to action!
                </button>
            </div>
        </div>
